...
public class SoapHelper extends HelperBase{
    ...
    //getProjects - метод, возвращающий полученные данные в преобразованном виде
    public Set<Project> getProjects() throws MalformedURLException, ServiceException, RemoteException {
        //создать соединение MantisConnect
        MantisConnectPortType mc = getMantisConnect();
        //обращение к MantisConnectPort. Получение списка пользователей доступ к которым имеет administrator.
    ...
    private MantisConnectPortType getMantisConnect() throws ServiceException, MalformedURLException {
        return new MantisConnectLocator()
                    .getMantisConnectPort(new URL (app.getProperty("soap.connetcUrl")));
    }
